...
const occasionProfiles: OccasionProfile[] = [
  {
    ...
    outfitCategories: ['tops', 'bottoms', 'outerwear', 'shoes'],
    fallbackCategories: ['outerwear', 'tops', 'bottoms', 'shoes'],
    tips: ['Tuck the top in, keep the silhouette clean, and use one structured layer if you have it.'],
  },
  {
    ...
    outfitCategories: ['tops', 'bottoms', 'outerwear', 'shoes'],
    fallbackCategories: ['outerwear', 'tops', 'bottoms', 'shoes'],
    tips: ['Choose darker shoes, avoid loud prints, and let one clean layer do the heavy lifting.'],
  },
  {
    keywords: ['date', 'dinner', 'night out', 'party', 'event'],
    title: 'Date-night',
    summary: 'I would make it a little softer and more intentional.',
    outfitCategories: ['tops', 'bottoms', 'shoes', 'outerwear'],
    fallbackCategories: ['tops', 'outerwear', 'bottoms', 'shoes'],
  ...
  },
  {
    ...
    outfitCategories: ['tops', 'bottoms', 'shoes'],
    fallbackCategories: ['tops', 'bottoms', 'shoes', 'outerwear'],
...
const fallbackProfile: OccasionProfile = {
  ...
  outfitCategories: ['tops', 'bottoms', 'shoes'],
  fallbackCategories: ['outerwear', 'tops', 'bottoms', 'shoes', 'accessories'],
